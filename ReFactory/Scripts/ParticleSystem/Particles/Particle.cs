...
namespace ReFactory.ParticleSystem.Particles
{
    ...
    public class Particle
    {
        ...
        {
            spriteBatch.Draw(_data.texture, _position - canvas.ViewportOffset.ToPoint().ToVector2(), null, _color * _opacity, 0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 1f);
        }
    }
}