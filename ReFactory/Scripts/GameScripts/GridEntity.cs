...
public abstract class GridEntity : Entity
{
    ...
    protected override void DrawSprite(SpriteBatch batch, Canvas canvas)
    {
        ...
        batch.Draw(sprite, new Rectangle(virtualPosition.ToPoint() + halfSize.ToPoint() - canvas.ViewportOffset.ToPoint(), new Point(sprite.Width, sprite.Height)), null, Color.White, MathHelper.ToRadians(rotation), halfSize, SpriteEffects.None, 0);
    }
}