...
public class Entity : IDisposable
{
    ...
    protected virtual Vector2 virtualPosition => position;
    ...
    protected virtual void DrawSprite(SpriteBatch spriteBatch, Canvas canvas)
    {
        ...
        spriteBatch.Draw(sprite, new Rectangle(virtualPosition.ToPoint() - canvas.ViewportOffset.ToPoint(), new Point(sprite.Width, sprite.Height)), Color.White);
    }
