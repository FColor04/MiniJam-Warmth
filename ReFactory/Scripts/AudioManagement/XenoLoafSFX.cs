...
namespace AudioManagement
{
    ...
    public class SoundEmitterBase
    {
        ...
        public SoundEffectInstance SFXSound { get { return sfxSound; } set { sfxSound = value; } } // Public Get and Set for Sound Effect.
        private Vector2 position; // The Emitters Location.
        public Vector2 Position { get { return position; } set { position = value; } // Public Getter for location
    }
	...
	public class ObjectSoundEmitter : SoundEmitterBase
	{
		...
		public float EmitterMaxVolume { get { return emitterMaxVolume; } }
		public float EmitterMinVolume { get { return emitterMinVolume; } }
		public float EmitterVolumeSlide { get { return emitterVolumeSlide; } set { emitterVolumeSlide = value; } }
        ...
        public void Update(Vector2 playerPosition)
		{
			for (int i = radii.Length - 1; i >= 0; i--)
			{
				...
				if (distance <= radii[i])
				{
					float t = RFMath.InverseLerp(radii[i], radii[0], distance);
    ...
    public class PlayerSoundEmitter : SoundEmitterBase
    {
        ...
        public float Noise { get { return noiseVal; } set { noiseVal = value; } }
        public float MovementMultiplier { get { return movementMultiplier; } set { movementMultiplier = value; } }
        public bool IsMoving { get { return isMoving; } set { isMoving = value; } }

        public PlayerSoundEmitter(SoundEffectInstance Sound, Vector2 playerPosition, float radius, float movementMultiplier, float noiseVal)
        {
